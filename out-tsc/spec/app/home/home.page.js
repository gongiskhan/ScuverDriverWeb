...
let HomePage = class HomePage {
    ...
    setUser() {
        return new Promise(resolve => {
            let authUser = localStorage.getItem('scuver_driver_user');
            if (authUser) {
    ...
    bringing(order) {
        if (this.orderWithinDistance(order)) {
            ...
            if (confirm('Aceitar encomenda?')) {
                ...
                this.deliveringOrder = Object.assign(Object.assign({}, order), { status: 'bringing' });
            }
            // } else {
